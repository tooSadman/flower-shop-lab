...
docker exec -ti flowershop_db bash -c "PGPASSWORD=mysecretpassword psql -U postgres -f pgsql.sql && PGPASSWORD=mysecretpassword psql -d flowershop -U postgres -f 20200529014155_create_db.up.sql"
